...
namespace FIT5032_Week05.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,CustomerId,OrderDate,OrderSum")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,CustomerId,OrderDate,OrderSum")] Order order)
        {
            if (ModelState.IsValid)
            {
